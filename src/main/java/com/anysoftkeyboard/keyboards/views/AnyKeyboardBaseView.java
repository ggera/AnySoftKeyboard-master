...
import com.ethiopic.android.anysoftkeyboard.AmharicKeyboard;
...
public class AnyKeyboardBaseView extends View implements
    ...
    private CharSequence adjustLabelToShiftState(AnyKey key) {
        ...
        AmharicKeyboard am=new AmharicKeyboard();

       if (am.isAmharicAlphabetRange(key)&&  mKeyboardName.equalsIgnoreCase("Amharic")&&am.isAmharicRootLetter(key))
        {
            if( key.pressed )
            {

                label=( key.popupCharacters != null&&mKeyboard.isShifted())?key.popupCharacters:key.label;
                ...
                System.out.println("DEBUG MESSAGE KEY=" + key.label+ " KEYCODE=" +  key.label.hashCode());
                switch ((mKeyboard.isShifted()&&key.label.hashCode()<=4951)?key.popupCharacters.hashCode():key.label.hashCode())
                {
                    ...
                    keys.get(37).label=(char)(4963)+"";
                //    label=(char)(4963)+"";

                    invalidateKey(keys.get(40));
                    keys.get(40).label=(char)(4962)+"";
                //    label=(char)(4962)+"";


                    invalidateKey(keys.get(39));
                    keys.get(39).label=(char)(4961)+"";
        ...
        if (mKeyboard.isShifted()) {
            ...
            } else if (mKeyboardName.equalsIgnoreCase("Amharic") && key.popupCharacters != null ) {
                label = key.popupCharacters;

                        invalidateKey(keys.get(36));
                        keys.get(36).label=(char)(63)+"";

                        invalidateKey(keys.get(37));
                        keys.get(37).label=(char)(4964)+"";

                        invalidateKey(keys.get(39));
                        keys.get(39).label=(char)(4966)+"";

                        invalidateKey(keys.get(40));
                        keys.get(40).label=(char)(4962)+"";
                        System.out.println("DEBUG MESSAGE KEY=" + key.label+ " KEYCODE=" +  key.label.hashCode());
                System.out.println("DEBUG MESSAGE KEY=" + key.label+ " KEYCODE=" +  key.label.hashCode()+ keys.get(37));

                switch (key.label.hashCode())
                {
                    case 63:
                        invalidateKey(keys.get(36));
                        keys.get(36).label=(char)(63)+"";
    ...
    protected static boolean isShiftKey(final AnyKey key) {
        return key.getPrimaryCode() == KeyCodes.SHIFT;
    }
